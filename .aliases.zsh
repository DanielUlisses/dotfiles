...
alias tls='tmuxifier load-sessions'
...
alias gprune 'gitPruneBranch() { git fetch --prune && for branch in `git branch -vv | grep ": gone]" | awk "{print $1}"`; do git branch -D $branch; done }; gitPruneBranch'
